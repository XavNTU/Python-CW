...
flight2 = Flight("F2", "Germany", "United Airline 2", "Airline3434", "TX", 350, 600, "14:00")
    ...
    if option == 1:
        while True:
            ...
            if sub_choice == '1':
                ...
                print(f"{flight1.aircraft_number} Airline")
                print(f"{flight2.aircraft_number} Airline")
                print(f"{flight3.aircraft_number} Airline")
                print(f"{flight4.aircraft_number} Airline")
                print(f"{flight5.aircraft_number} Airline")
